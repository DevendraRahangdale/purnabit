...
"
  ...
  "
        ...
        "
                >
                  Database{" "}
                  <span className="text-[#008080]">Services & Solutions</span>
                </h1>
        ...
        "
                >
                  ...
                  Specializing in high-availability setups, performance tuning,
                  disaster recovery, and Kubernetes deployments.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 hover:shadow-2xl transition">
              <div className="mb-10">
                ...
                <p className="mt-4 text-gray-600">
                  End-to-end database management services for optimal
...
>
  {/* Decorative glow */}
  <div className="absolute -top-20 -right-20 w-72 h-72 bg-[#008080]/10 blur-3xl rounded-full" />
  ...
  >
    ...
    >
      ...
      <span className="text-[#008080]">Database Infrastructure?</span>
    </motion.h2>
    ...
    <motion.p
      ...
      "
    >
      Contact us for a comprehensive database assessment and a
      customized solution proposal. We provide expert consultation for
